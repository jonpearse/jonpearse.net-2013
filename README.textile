...
This is the source code for the old version of my website, launched 2013. The code for newer (2018) version will be made available at some point in the near future. 

This codebase has been abandoned, and will not be updated further—those wishing to take inspiration should ensure any dependencies are updated before use.
...
* bumping gems to latest version
* fixing responsive image shenanigans (you should no longer always see mobile versions)

h3. March 25th, 2016

* bumping gems to latest version
* fixing 500 when requesting non-existent content

h3. November 15th, 2015

* updating to Rails 4.2
* updating Capistrano to something a little more modern
* replacing icon fonts with SVGs
* rewriting HTML/CSS to contain 100% more BEM
* rewriting JS to be more behaviour-driven/optimised
* introducing a little vertical rhythm to proceedings

h3. December 8th, 2014

Altering method of styling checkbox on comment form so it actually works in IE—really embarrassed it took this long to realise it wasn’t working :s

h3. December 6th, 2014

* updating Rails & other gems to latest
* removing pubdate attr from front-end
* fixing a couple odd bugs
* adding favicon
