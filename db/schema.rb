...
ActiveRecord::Schema.define(:version => 20130807151313) do
  ...
  add_index "articles", ["full_url", "published"], :name => "index_articles_on_full_url_and_published"
  add_index "articles", ["full_url"], :name => "index_articles_on_full_url", :unique => true
  add_index "articles", ["published", "published_on"], :name => "published"
  ...
  add_index "categories", ["url_slug"], :name => "index_categories_on_url_slug", :unique => true
  ...
  add_index "pages", ["url_slug"], :name => "index_pages_on_url_slug", :unique => true
  ...
  add_index "previews", ["user_id", "model_name"], :name => "index_previews_on_user_id_and_model_name"
